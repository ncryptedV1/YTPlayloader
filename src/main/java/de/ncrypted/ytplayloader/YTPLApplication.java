...
public class YTPLApplication extends Application {
  ...
  static {
    try {
      jarDir = new File(YTPLApplication.class.getProtectionDomain()
          .getCodeSource()
          .getLocation()
          .toURI())
          .getParentFile()
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    primaryStage.getIcons()
        .add(new Image(
            YTPLApplication.class.getClassLoader().getResourceAsStream("blackyt_arrow.png")));
